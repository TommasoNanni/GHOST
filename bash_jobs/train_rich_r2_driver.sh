#!/bin/bash
# Drive the R2 fusion training to completion through 1:30 debug jobs.
#
# R2 = CHANGE 1 (L_joint on root + 21 body joints, L_pose hands 3x) + CHANGE 2
# (kinematic-tree hard mask, k=2, on the joint-attention axis). Joint-confidence
# bias stays OFF.
#
...
#   stop: pkill -f train_rich_r2_driver
#
...
SCENE_JOB="bash_jobs/train_rich_r012.sh"
JOB_NAME="tr${RUN}"
POLL=180
